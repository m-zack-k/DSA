public class Solution {
    const int BIG_NUM = 100001;

    public bool CanPartitionGrid(int[][] grid) {
        int m = grid.Length, n = grid[0].Length; 
        long total = 0;

        int[] bottom = new int[BIG_NUM];
        int[] top = new int[BIG_NUM]; 
        ...
        int[] left = new int[BIG_NUM];
        int[] right = new int[BIG_NUM];
    ...
    private bool Check(int[] sum, int[][] grid, int r1, int r2, int c1, int c2, long diff) {
